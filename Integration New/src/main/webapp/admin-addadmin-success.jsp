   ...
   <div class="leftarrow" onclick="goBack()" disabled>&lt;</div>
    <div class="rightarrow" onclick="goForward()" disabled>&gt;</div> 
                        ...
                        <div class="col-md-9 nav-col">
                            <nav class="navbar navbar-expand-lg navbar-light">
                                ...
                                <div class="collapse navbar-collapse" id="navbarNav">
                                    <ul class="navbar-nav">
                                        <li class="nav-item">
                                            <a class="nav-link" href="admin-viewusers.jsp">view users</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="admin-viewstock.jsp">View Stock</a>
                                        </li>
                                       
                                        <li class="nav-item">
                                            <a class="nav-link" href="admin-viewrequest.jsp">View Request</a>
                                        </li>
                                        <li class="nav-item active">
                                            <a class="nav-link" href="admin-viewrequest.jsp">Add Admin</a>
                                        </li>
                                    </ul>
                                </div>
                            </nav>
        ...
        <div class="work">
             ...
             <jsp:include page="admin-addadminform.jsp"></jsp:include>
        </div>
    <!-- ################# Slider Starts Here#######################--->
   
     <!--*************** Footer  Starts Here *************** -->
    <footer id="contact" class="container-fluid" style="margin:150px 30px 0px -330px;width:200%;">
        <div class="container">
