...
<head>
    ...
    <title>Web App Landing Page Website Template | Smarteyeapps.com</title>
...
<body>
            ...
            <div class="container">
                <div class="row col-det">
                    <div class="col-lg-6 d-none d-lg-block">
                        <ul class="ulleft">
                            <li><i class="far fa-envelope"></i> gouthamrmc@gmail.com <span>|</span></li>
                            <li><i class="far fa-clock"></i> Service Time : 24 X 7</li>
                        </ul>
                    </div>
                    ...
                    <div class="col-md-9 nav-col">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="navbarNav">
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link" href="user-addblood.jsp">Add Donor
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="user-contactus.jsp">Contact Us</a>
                                    </li>
    ...
    <div class="work">
                   ...
                   <jsp:include page="user-dashboard-body.jsp"></jsp:include>
