...
<div class="custom-container" style="margin:50px auto 0px auto;height:70vh;">
      ...
      <form action="adduser-madhavi.jsp" method="post">
         ...
         <div class="custom-row">
            <div class="custom-input">
               ...
               <select style="padding-right:25px;margin-left:130px;padding-left:20px;;text-align:center;">
            ...
            <div class="custom-input">
               <select name="cars" id="cars" style="padding-right:25px;padding-left:25px;text-align:center;">
               <option value="units">units</option>
               <option value="1unit">1 unit</option>
               <option value="2units">2 units</option>
               <option value="3units">3 units</option>
               <option value="4units">4 units</option>
           </select> 
               <div class="custom-underline"></div>
               <label for="" style="margin-left:10px;">Blood Volume</label>
            </div>
         </div>
         <div class="custom-row">
