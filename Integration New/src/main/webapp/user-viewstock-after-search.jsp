...
<head>
    ...
    <title>view stock after search</title>
...
<body>
    ...
    <div class="rightarrow" onclick="goForward()" disabled>&gt;</div> 
                        ...
                        <div class="col-md-9 nav-col">
                            <nav class="navbar navbar-expand-lg navbar-light">
                                ...
                                <div class="collapse navbar-collapse" id="navbarNav">
                                    <ul class="navbar-nav">
                                        <li class="nav-item">
                                            <a class="nav-link" href="user-addblood.jsp">Add Donar
                                            </a>
                                        </li>
        ...
        <div class="work">
             ...
             <jsp:include page="madhavi-search-viewstock.jsp"></jsp:include>
        </div>
    <!-- ################# Slider Starts Here#######################--->
      ...
      <!--*************** Footer  Starts Here *************** -->
    <footer id="contact" class="container-fluid" style="margin-top:350px;">
        <div class="container">
